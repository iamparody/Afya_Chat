# Symptom & Finding Vocabulary

#vocabulary #controlled-terms

← Back to [[CLAUDE]] | [[index]] | [[glossary]]

> [!NOTE]
> All terms used in `graph:` blocks across condition cards must appear in this list.
> To add a new term: add it here first, then use it in the card. This prevents synonym drift.
> For condition names used in `differentials:` blocks, see [[conditions_vocabulary]].
...
| pallor | paleness |
| anaemia | |
| dyspnoea on exertion | exertional breathlessness, shortness of breath on exercise |
...
| tingling feet | paraesthesia feet |
| numbness feet | |
| peripheral neuropathy | |
| acanthosis nigricans | |
| occipital headache on waking | morning headache |
| palpitations | |
| chest pain | |
| epistaxis | nosebleed |
| visual disturbance | |
...
| abdominal cramps | abdominal colic |
| bloody stool | blood in stool, bloody diarrhoea |
| mucoid stool | |
...
| fundoscopic changes | retinal changes |
| papilloedema | disc swelling |
| epigastric tenderness | |
| systolic flow murmur | functional murmur |
| lightheadedness | dizziness |
| dehydration | |
| sunken fontanelle | |
| respiratory distress | respiratory compromise |
| altered consciousness | impaired consciousness |
...
| Canonical Term | Do Not Use |
|---|---|
| HIV infection | HIV/AIDS, HIV positive |
| HIV co-infection | HIV positive with co-infection |
| diabetes mellitus | DM, diabetes |
| pregnancy | |
| obesity | overweight and obese |
| overweight | |
| smoking | tobacco use |
| excessive alcohol | alcohol use disorder |
| age under five | children under five |
| age under 2 months | neonatal age |
| age over 45 | middle age and above |
| age over 65 | elderly, older adults |
| elderly | older adults |
| advancing age | increasing age |
...
| no acquired immunity | non-immune individual |
...
| East African ethnicity | East African background |
| South Asian ethnicity | South Asian background |
| sub-Saharan Africa ethnicity | |
| menorrhagia | heavy menstrual bleeding, heavy periods |
| chronic gastrointestinal blood loss | GI blood loss |
| inadequate dietary iron | low iron diet |
| lactation | breastfeeding |
| adolescent growth | adolescent growth spurt |
| coeliac disease | celiac disease |
| hookworm infestation | hookworm infection |
...
| antiepileptic use | antiepileptic medication |
...
| Canonical Term | Do Not Use |
|---|---|
| altered consciousness | impaired consciousness, change in consciousness |
| coma | unconsciousness, unresponsiveness |
| seizures | convulsions, fits |
| respiratory distress | severe respiratory distress |
| severe anaemia | |
...
| foot ulceration with systemic features | diabetic foot with sepsis |
| rapidly deteriorating renal function | acute kidney injury |
| acute coronary syndrome | ACS, heart attack, myocardial infarction |
| aortic dissection | |
| acute pulmonary oedema | acute pulmonary edema, flash pulmonary oedema |
...
| progressive dysphagia | worsening dysphagia |
| palpable epigastric mass | epigastric mass |
| haemodynamic instability | cardiovascular instability |

---

## Red Flags — Threshold Criteria

| Canonical Term | Notes |
|---|---|
| haemoglobin <7 g/dL | severe anaemia threshold (adults) |
| anaemia in pregnancy below 7 g/dL | severe maternal anaemia threshold |
| haemoptysis >200 mL per 24 hours | surgical emergency threshold |
| oxygen saturation <94% | hypoxia threshold requiring intervention |
| BP ≥180/120 with end-organ damage | hypertensive emergency threshold |
| CURB-65 score ≥3 | high mortality CAP threshold |
| HIV with CD4 <200 cells/μL | advanced HIV immunosuppression threshold |
| PCP with CD4 <200 | Pneumocystis pneumonia risk threshold |

---

## Investigations / Confirms

| Canonical Term | Notes |
|---|---|
| fasting plasma glucose ≥7.0 mmol/L | diabetes threshold |
| HbA1c ≥48 mmol/mol | = 6.5% |
| OGTT two-hour glucose ≥11.1 mmol/L | |
| random plasma glucose ≥11.1 mmol/L with symptoms | |
| BP ≥140/90 on two separate occasions | hypertension threshold |
| daytime ABPM ≥135/85 | 24h ambulatory monitoring |
| left ventricular hypertrophy on ECG | Sokolow-Lyon or Cornell criteria |
| elevated urine albumin:creatinine ratio | |
| BMI ≥30 kg/m² | obesity threshold |
| waist circumference >102 cm in men | central obesity |
| waist circumference >88 cm in women | central obesity |
| positive malaria RDT | antigen detection |
| positive thick blood film | gold standard species ID |
| positive thin blood film | |
| positive PCR for malaria | low-density parasitaemia |
| positive GeneXpert MTB/RIF | TB + rifampicin resistance |
| positive AFB smear | Ziehl-Neelsen or auramine |
...
| reticulocyte rise after oral iron | functional response test |
| ulcer on upper GI endoscopy | gold standard for PUD |
| positive H. pylori CLO test | on biopsy |
...
| acute onset under 7 days | very short history |
| diarrhoea persisting beyond 14 days | |
